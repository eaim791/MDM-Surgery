...
const PROCEDURE_LIST = [
  ...
  { slug: "tensor-threads", icon: Feather,
    es: { name: "Hilos Tensores", desc: "Reposición de los tejidos del rostro mediante hilos, sin necesidad de cirugía abierta.", duration: "Alrededor de 1 hora", recovery: "3 a 7 días", who: "Para quienes buscan un efecto lifting sutil sin pasar por cirugía abierta." },
    en: { name: "Tensor Threads", desc: "Repositioning of facial tissues with threads, without the need for open surgery.", duration: "About 1 hour", recovery: "3 to 7 days", who: "For those looking for a subtle lifting effect without open surgery." } },
