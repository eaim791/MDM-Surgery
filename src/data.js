...
const PROCEDURE_LIST = [
  { slug: "facial-harmonization", icon: Aperture,
    es: { name: "Armonización Facial", desc: "Evaluación y remodelación del rostro como conjunto, combinando varios gestos quirúrgicos en un mismo plan para equilibrar las proporciones.", duration: "Variable según el plan", recovery: "2 a 3 semanas", who: "Para quienes buscan equilibrar el rostro como conjunto, sin un objetivo puntual en una sola zona." },
    en: { name: "Facial Harmonization", desc: "Assessment and remodeling of the face as a whole, combining several surgical steps in a single plan to balance proportions.", duration: "Varies with the plan", recovery: "2 to 3 weeks", who: "For those looking to balance the face as a whole, without a single specific target area." } },
  { slug: "forehead-orbital", icon: Scan,
    es: { name: "Frente y Órbitas", desc: "Remodelación del hueso frontal y del reborde orbitario para modificar la proyección y la forma de la frente.", duration: "2 a 3 horas", recovery: "2 a 3 semanas", who: "Para quienes sienten la frente muy plana, muy prominente o desproporcionada con el resto del rostro." },
    en: { name: "Forehead & Orbital", desc: "Remodeling of the frontal bone and orbital rim to change the projection and shape of the forehead.", duration: "2 to 3 hours", recovery: "2 to 3 weeks", who: "For those who feel their forehead is too flat, too prominent, or out of proportion with the rest of the face." } },
  { slug: "chin-jaw", icon: Triangle,
    es: { name: "Remodelación de Mentón y Mandíbula", desc: "Modificación del contorno óseo del mentón y del ángulo mandibular para redefinir el tercio inferior del rostro.", duration: "2 a 4 horas", recovery: "2 a 3 semanas", who: "Para quienes buscan definir o suavizar el tercio inferior del rostro, con mentón retraído, prominente o mandíbula poco marcada." },
    en: { name: "Chin & Jaw Remodeling", desc: "Reshaping of the bone contour of the chin and jaw angle to redefine the lower third of the face.", duration: "2 to 4 hours", recovery: "2 to 3 weeks", who: "For those looking to define or soften the lower third of the face, with a receding or prominent chin, or an undefined jawline." } },
  { slug: "eyes-expression", icon: Eye,
    es: { name: "Expresión de la Mirada", desc: "Conjunto de gestos sobre párpados, cejas y región periorbitaria orientados a modificar la expresión de la mirada.", duration: "1 a 3 horas", recovery: "7 a 14 días", who: "Para quienes sienten que su mirada se ve cansada, caída o no refleja cómo se sienten." },
    en: { name: "Eyes Expression", desc: "A set of procedures on the eyelids, brows and periorbital area aimed at changing the expression of the gaze.", duration: "1 to 3 hours", recovery: "7 to 14 days", who: "For those who feel their gaze looks tired, droopy, or doesn't reflect how they feel." } },
  { slug: "feminization", icon: Flower2,
    es: { name: "Feminización", desc: "Conjunto de gestos quirúrgicos sobre la estructura ósea y los tejidos blandos orientados a suavizar los rasgos del rostro.", duration: "Variable según el plan", recovery: "3 a 4 semanas", who: "Para pacientes en proceso de transición de género, o que buscan afirmar rasgos faciales femeninos." },
    en: { name: "Feminization", desc: "A set of surgical steps on the bone structure and soft tissues aimed at softening the features of the face.", duration: "Varies with the plan", recovery: "3 to 4 weeks", who: "For patients transitioning gender, or those looking to affirm feminine facial features." } },
  { slug: "rejuvenation", icon: Sparkles,
    es: { name: "Rejuvenecimiento Facial", desc: "Tratamiento de los signos de la edad en el rostro y el cuello, combinando reposición de tejidos y trabajo sobre la calidad de la piel.", duration: "Variable según el plan", recovery: "2 a 3 semanas", who: "Para quienes buscan revertir signos de la edad sin cambiar la identidad de sus rasgos." },
    en: { name: "Facial Rejuvenation", desc: "Treatment of the signs of ageing in the face and neck, combining tissue repositioning and work on skin quality.", duration: "Varies with the plan", recovery: "2 to 3 weeks", who: "For those looking to reverse signs of ageing without changing the identity of their features." } },
  { slug: "masculinization", icon: Hexagon,
    es: { name: "Masculinización y Antiaging", desc: "Plan combinado que marca los rasgos y trata los signos de la edad en un mismo tiempo quirúrgico.", duration: "Variable según el plan", recovery: "3 a 4 semanas", who: "Para pacientes en proceso de transición de género, o que buscan afirmar rasgos faciales masculinos." },
    en: { name: "Masculinization & Antiaging", desc: "A combined plan that strengthens the features and addresses signs of ageing in a single surgical session.", duration: "Varies with the plan", recovery: "3 to 4 weeks", who: "For patients transitioning gender, or those looking to affirm masculine facial features." } },
  { slug: "face-neck-lift", icon: MoveUp,
    es: { name: "Lifting Facial y Cervical", desc: "Reposición de los tejidos del rostro y del cuello, con tratamiento del plano muscular y de la piel para redefinir el óvalo facial.", duration: "3 a 5 horas", recovery: "2 a 3 semanas", who: "Para quienes notan flacidez en el óvalo facial y el cuello que ya no responde a tratamientos no quirúrgicos." },
    en: { name: "Face & Neck Lift", desc: "Repositioning of facial and neck tissues, treating the muscular plane and the skin to redefine the facial oval.", duration: "3 to 5 hours", recovery: "2 to 3 weeks", who: "For those noticing sagging in the facial oval and neck that no longer responds to non-surgical treatments." } },
  { slug: "rhinoplasty", icon: Wind,
    es: { name: "Rinoplastia", desc: "Modificación de la estructura ósea y cartilaginosa de la nariz para cambiar su forma, su proyección y su relación con el resto del rostro.", duration: "2 a 3 horas", recovery: "7 a 10 días con férula", who: "Para quienes no se sienten identificados con la forma de su nariz, de nacimiento o por un golpe o cirugía previa." },
    en: { name: "Rhinoplasty", desc: "Reshaping of the bone and cartilage structure of the nose to change its shape, projection and relationship with the rest of the face.", duration: "2 to 3 hours", recovery: "7 to 10 days with a splint", who: "For those who don't feel represented by the shape of their nose, whether from birth or a previous injury or surgery." } },
  { slug: "blepharoplasty", icon: Focus,
    es: { name: "Blefaroplastia", desc: "Corrección del exceso de piel y de las bolsas de los párpados superiores e inferiores.", duration: "1 a 2 horas", recovery: "7 a 10 días", who: "Para quienes tienen exceso de piel o bolsas en los párpados que afectan la mirada o, en casos avanzados, la visión." },
    en: { name: "Blepharoplasty", desc: "Correction of excess skin and fat pads of the upper and lower eyelids.", duration: "1 to 2 hours", recovery: "7 to 10 days", who: "For those with excess skin or fat pads on the eyelids that affect the gaze or, in advanced cases, vision." } },
  { slug: "cheeks", icon: Circle,
    es: { name: "Pómulos", desc: "Aumento o redefinición de la proyección malar mediante implantes o relleno estructural.", duration: "1 a 2 horas", recovery: "7 a 14 días", who: "Para quienes buscan mayor proyección o definición en los pómulos." },
    en: { name: "Cheeks", desc: "Augmentation or redefinition of malar projection using implants or structural filling.", duration: "1 to 2 hours", recovery: "7 to 14 days", who: "For those looking for more projection or definition in the cheekbones." } },
  { slug: "upper-lip-lift", icon: Smile,
    es: { name: "Lifting de Labio Superior", desc: "Acortamiento de la distancia entre la nariz y el labio para exponer más el bermellón y rejuvenecer el tercio medio.", duration: "Alrededor de 1 hora", recovery: "7 a 10 días", who: "Para quienes sienten el labio superior alargado o poco visible al sonreír." },
    en: { name: "Upper Lip Lift", desc: "Shortening of the distance between nose and lip to expose more vermilion and rejuvenate the middle third.", duration: "About 1 hour", recovery: "7 to 10 days", who: "For those who feel their upper lip is elongated or not visible enough when smiling." } },
  { slug: "adams-remodeling", icon: Activity,
    es: { name: "Remodelación de Nuez de Adán", desc: "Reducción del cartílago tiroides para suavizar el relieve del cuello.", duration: "1 a 2 horas", recovery: "7 a 10 días", who: "Para pacientes trans, o para quienes sienten que el relieve del cuello no representa cómo se ven." },
    en: { name: "Adam's Remodeling", desc: "Reduction of the thyroid cartilage to soften the contour of the neck.", duration: "1 to 2 hours", recovery: "7 to 10 days", who: "For trans patients, or for those who feel the contour of their neck doesn't represent how they see themselves." } },
  { slug: "hair-implants", icon: Feather,
    es: { name: "Implante Capilar", desc: "Redistribución de folículos propios para recomponer la línea de implantación y la densidad del cabello.", duration: "4 a 8 horas", recovery: "5 a 7 días", who: "Para quienes atraviesan caída de cabello, entradas marcadas o calvicie y buscan recomponer la línea de implantación." },
    en: { name: "Hair Implants", desc: "Redistribution of the patient's own follicles to rebuild the hairline and hair density.", duration: "4 to 8 hours", recovery: "5 to 7 days", who: "For those experiencing hair loss, a receding hairline, or baldness, looking to rebuild the hairline." } },
  { slug: "profiloplasty", icon: Aperture,
    es: { name: "Perfiloplastia", desc: "Trabajo conjunto sobre nariz, mentón y labios para redefinir la línea del perfil como una sola unidad.", duration: "3 a 4 horas", recovery: "2 a 3 semanas", who: "Para quienes quieren trabajar nariz, mentón y labios en conjunto, en vez de resolver cada zona por separado." },
    en: { name: "Profiloplasty", desc: "Combined work on nose, chin and lips to redefine the profile line as a single unit.", duration: "3 to 4 hours", recovery: "2 to 3 weeks", who: "For those who want to work on the nose, chin and lips together, rather than addressing each area separately." } },
  { slug: "tensor-threads", icon: Feather,
    es: { name: "Hilos Tensores", desc: "Reposición de los tejidos del rostro mediante hilos, sin cirugía abierta, para redefinir el contorno.", duration: "Alrededor de 1 hora", recovery: "3 a 7 días", who: "Para quienes buscan un efecto lifting sutil sin pasar por cirugía abierta." },
    en: { name: "Tensor Threads", desc: "Repositioning of the facial tissues with threads, without open surgery, to redefine the contour.", duration: "About 1 hour", recovery: "3 to 7 days", who: "For those looking for a subtle lifting effect without open surgery." } },
  { slug: "breast", icon: Gem,
    es: { name: "Mamas", desc: "Aumento, reducción o elevación mamaria, con implantes o tejido propio, según la proporción buscada para el conjunto del cuerpo.", duration: "2 a 3 horas", recovery: "2 a 4 semanas", who: "Para quienes buscan cambiar el volumen, la forma o la posición del busto." },
    en: { name: "Breast", desc: "Breast augmentation, reduction or lift, with implants or the patient's own tissue, according to the proportion sought for the whole body.", duration: "2 to 3 hours", recovery: "2 to 4 weeks", who: "For those looking to change the volume, shape or position of the bust." } },
  { slug: "body-remodeling", icon: PersonStanding,
    es: { name: "Remodelación Corporal", desc: "Modelado del contorno corporal mediante lipoaspiración, tratamiento de la pared abdominal y remodelación de zonas específicas.", duration: "2 a 5 horas", recovery: "3 a 4 semanas", who: "Para quienes buscan redefinir el contorno corporal después de un cambio de peso, embarazo o por planeamiento estético." },
    en: { name: "Body Remodeling", desc: "Body contour shaping through liposuction, abdominal wall treatment and remodeling of specific areas.", duration: "2 to 5 hours", recovery: "3 to 4 weeks", who: "For those looking to redefine their body contour after a weight change, pregnancy, or aesthetic planning." } },
];
...
export const AREAS = [
  { es: { t: "Feminización Facial", d: "Estética facial completa orientada a la feminización.",
          who: "Para pacientes en proceso de transición de género, o que buscan afirmar rasgos faciales femeninos." },
    en: { t: "Facial Feminization", d: "Full-face aesthetics oriented toward feminization.",
          who: "For patients transitioning, or looking to affirm feminine facial features." } },
  { es: { t: "Masculinización Facial", d: "Estética facial completa orientada a la masculinización.",
          who: "Para pacientes en proceso de transición de género, o que buscan afirmar rasgos faciales masculinos." },
    en: { t: "Facial Masculinization", d: "Full-face aesthetics oriented toward masculinization.",
          who: "For patients transitioning, or looking to affirm masculine facial features." } },
  { es: { t: "Armonización de Rasgos", d: "Remodelación de las estructuras faciales como conjunto.",
          who: "Para quienes buscan equilibrar las proporciones del rostro, sin cambiar su identidad facial." },
    en: { t: "Facial Features Harmonization", d: "Remodeling of the facial structures as a whole.",
          who: "For those looking to balance facial proportions, without changing their facial identity." } },
  { es: { t: "Cirugía Corporal", d: "Modelado y remodelación estética del cuerpo.",
          who: "Para quienes buscan remodelar el contorno corporal tras un cambio de peso, embarazo, o por planeamiento estético." },
    en: { t: "Body Surgery", d: "Aesthetic body shaping and remodeling.",
          who: "For those looking to reshape their body contour after weight change, pregnancy, or aesthetic planning." } },
];
